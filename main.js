    ...
    forms.forEach(form => {
        if (form) {
            form.addEventListener('submit', (e) => {
                ...
                formData.append('cuando', rawFormData.get('cuando') || '');
                ...
                fetch('https://script.google.com/macros/s/AKfycbz8MC4A8DD1eemyNkXzTuT6NyLD8c3whbPgtBoraOp1IowfAmbiHRwGTgG25LBBNtcnkA/exec', {
                    method: 'POST',
                    mode: 'no-cors',
                    headers: {
